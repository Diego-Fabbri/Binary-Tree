...
//NB:La classe nodo di un albero di modifica . Adesso ogni nodi ha due puntatori a due nodi figli oltre a parte informativa
	...
	public Node(int info) {//costruttore che riceve solo contenuto informativo
		this.info  = info;
		this.left  = null;// non si settano nodi figli; il nodo così definito sarà una foglia 
		this.right = null;
	}
...
•nullo, se l’oggetto (this) è uguale al parametro “o”
• positivo, se l’oggetto(this) è maggiore al parametro “o” */
	...
	//METODO CHE CI DICE SE IL NODO SU CUI SI CHIAMA (this) è UNA FOGLIA
